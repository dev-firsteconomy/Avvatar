				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<input id="name" type="text" name="name" placeholder="Enter Name" value="{{ $product->name }}" class="form-control">
							@error('name')
							<span class="text-danger">{{$message}}</span>
							@enderror
						</div>
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<input id="hsn" type="text" name="hsn" placeholder="Enter HSN" value="{{ $product->hsn }}" class="form-control">
							@error('hsn')
							<span class="text-danger">{{$message}}</span>
							@enderror
						</div>
						...
						<div class="form-group">
							...
							<select name="related_products" id="related_products" class="form-control">
								@foreach($related_products as $key=>$product)
									<option {{ ( ($product->related_products == $product->id) ? 'selected' : '') }}  value='{{$product->id}}'>{{$product->name}}</option>
								@endforeach
							</select>
