						...
						<div data-repeater-list="sizeWiseImage_group">
							<div class="row" data-repeater-item>
								...
								<div class="form-group col-md-2">
									...
									<input id="stock_quantities" type="number" name="stock_quantities" min="0" placeholder="Enter Stock quantity" value="{{ old('stock_quantities') }}" class="form-control" >
								</div>
				...
				<div class="row">     
					...
					<div class="form-group">
						...
						<label class="form-check-label">
							<input type="checkbox" id="is_featured" name="is_featured" class="form-check-input" value="1" {{isset($product) && $product->is_featured == 1 ? 'checked' : '' }}>Is Featured ? <i class="input-helper"></i>
						</label>
						</div>
					</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="form-check form-check-primary">
						<label class="form-check-label">
							<input type="checkbox" id="is_new" name="is_new" class="form-check-input" value="1" {{isset($product) && $product->is_new == 1 ? 'checked' : '' }}>Is New ? <i class="input-helper"></i>
						</label>
						</div>
					</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="form-check form-check-primary">
						<label class="form-check-label">
							<input type="checkbox" id="is_bestsellers" name="is_bestsellers" class="form-check-input" value="1" {{isset($product) && $product->is_bestsellers == 1 ? 'checked' : '' }}>Is Bestsellers ? <i class="input-helper"></i>
						</label>
						</div>
					</div>
					</div>
