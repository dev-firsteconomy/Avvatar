...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            ...
            <a href="{{route('sizes.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip"
                data-placement="bottom" title="Add Size"><i class="fas fa-plus"></i> Add Size</a>
        </div>
        <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" action="{{route('sizes.destroy',[$size->id])}}">
                                    @csrf
                                    @method('delete')
                                    <button class="btn btn-danger btn-sm dltBtn" data-id={{$size->id}}
