...
<main class="main">
    <input type="hidden" name="pageValue" id="pageValue"
        value="{{ request()->has('offerValue') ? decrypt(request()->query('offerValue')) : 0 }}">
            ...
            <div class="product-details-tab">
                <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="product-description" data-bs-toggle="tab"
                            data-bs-target="#product-description-pane" type="button" role="tab"
                            aria-controls="product-description-pane" aria-selected="true">Description</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="product-information" data-bs-toggle="tab"
                            data-bs-target="#product-information-pane" type="button" role="tab"
                            aria-controls="product-information-pane" aria-selected="false">Additional
                            information</button>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="product-description-pane" role="tabpanel"
                        aria-labelledby="product-description" tabindex="0">
                        <div class="product-desc-content">
                            <h3>Product Information</h3>
                            {!! $product->description !!}
                        </div><!-- End .product-desc-content -->
                    </div><!-- .End .tab-pane -->
                    <div class="tab-pane fade" id="product-information-pane" role="tabpanel"
                        aria-labelledby="product-information" tabindex="0">
                        <div class="product-desc-content">
                            <h3>Information</h3>
                ...
                <div class="product product-7 text-center">
                    <figure class="product-media">
                        ...
                        <a href="{{url('product/' .$product->slug)}}">
                            <img src="{{asset(@$product->images()->first()->image)}}"
                                alt="{!! @$product->meta_description !!}" class="product-image">
                        </a>
                        ...
                        <div class="product-action-vertical">
                            ...
                            <a href="javascript:void(0);"
                                ...
                                data-id="{{$product->id}}" id="wishlist{{$product->id}}"><span
                                    class="add_to_wishlist_msg{{$product->id}}">add to wishlist</span></a>
                            @else
                            <a href="#signin-modal" data-toggle="modal"
                                class="btn-product-icon btn-wishlist btn-expandable" data-id="{{$product->id}}"
                                id="wishlist{{$product->id}}"></a>
                            @endif
                    ...
                    <div class="product-body">
                            ...
                            <div class="radio has-color">
                                <label>
                                    <input type="radio" name="color" value="{{@$color->color_id}}"
                                        class="p-cradio colorOptions">
                                    <div class="custom-color"><span
                                            style="background-color:{{@$color->productColor->code}}"></span></div>
                                </label>
                            </div>
                            @endforeach
                        </div><!-- End .product-cat -->
                        ...
                        <div class="atc-container">
                            <div class="mb-0">
                                <a href="javascript:void(0);" class="btn-cart add_to_cart"
                                    data-id="{{$product->id}}"><span class="product{{$product->id}}">Add to
                                        cart</span></a>
                            </div>
                        </div>
