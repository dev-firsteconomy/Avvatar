		...
		<div class="checkout">
			<div class="container">
				...
				<form id="checkoutForm" action="javascript:void(0);" class="place_order" method="POST">
					...
					<div class="row">
						<div class="col-lg-7">
							<h2 class="checkout-title mt-0 fw-bold">Billing Details</h2><!-- End .checkout-title -->
							<div class="row">
								<div class="col-sm-6">
									<label>First Name *</label>
									<input type="text" class="form-control" name="first_name" value="{{@$user->name}}" placeholder="Enter your first name" required>
								</div><!-- End .col-sm-6 -->

								<div class="col-sm-6">
									<label>Last Name *</label>
									<input type="text" class="form-control" name="last_name" value="{{@$user->name}}" placeholder="Enter your last name" required>
								</div>
							</div><!-- End .row -->
