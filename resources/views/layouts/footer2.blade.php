<footer class="footer footer-light footer-zehna">
    <div class="footer-top p-5">
        <div class="container p-0">
            <div class="row">
                <div
                    class="col-sm-7 d-flex align-items-center justify-content-sm-start justify-content-center mb-0 mb-sm-5">
                    <div class="row f-wrap">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                <input type="text" class="form-control form-control-lg" placeholder="Email Adress"
                                    aria-label="Email Adress" id="newsletter-email" name="newsletter-email"
                ...
                <div class="col-sm-5 d-flex align-items-center justify-content-sm-end justify-content-center">
                    <div class="social-icons ">
                        <a href="https://www.facebook.com/profile.php?id=100078794362634" class="social-icon"
                            target="_blank" title="Facebook"><i class="icon-facebook-f"></i></a>
                        <a href="https://www.instagram.com/Zehna_in/" class="social-icon" target="_blank"
                            title="Instagram"><i class="icon-instagram"></i></a>
                        <a href="https://in.pinterest.com/sachhacreation/_saved/" class="social-icon" target="_blank"
                            title="Pintrest"><i class="icon-pinterest-p"></i></a>
...
<div class="mobile-menu-container mobile-menu-light">
    <div class="mobile-menu-wrapper">
        ...
        <form action="/products" method="get" class="mobile-search">
            ...
            <input type="search" class="form-control" name="search" id="search" placeholder="Search product ..."
                required>
                            ...
                            <div class="tab-pane fade show " id="register" role="tabpanel"
                                ...
                                <form method="post" action="{{route('register.submit')}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control keyup-email" id="email" name="email"
                                            required>
                                    </div><!-- End .form-group -->
