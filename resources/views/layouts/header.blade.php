        ...
        <div class="header-middle sticky-header">
            ...
            <div class="container main-header">
                <div class="header-left">
                    ...
                    <a href="/" class="logo">
                        <img src="{{URL::asset('assets/images/new/logo.png')}}" alt="Molla Logo" width="105"
                            height="25">
                    </a>
                </div>
                <div class="header-center">
                    <nav class="main-nav">
                        <ul class="menu sf-arrows">
                            <li>
                                <a href="/products" class="">Why Avatar</a>
                            </li>
                            ...
                            <li>
                                <a href="{{url('/media')}}" class="">media</a>
                            </li>
                            {{-- <li>
                ...
                <div class="header-right">
                        ...
                        <a href="{{route('user')}}?tab=wishlist" title="Wishlist">
                            ...
                            <a href="#signin-modal" data-toggle="modal">
                                ...
                                <div class="icon">
                                    ...
                                    <span
                                        class="wishlist-count badge">{{count(Helper::getAllProductFromWishlist())}}</span>
                                    @endif
                                </div>
                            </a>
                    </div>
                    ...
                    <div class="dropdown cart-dropdown">
                        @if(is_user_logged_in())
                        <a href="{{route('user-cart')}}" class="dropdown-toggle" role="button" aria-haspopup="true"
                            aria-expanded="false" data-display="static">
                            @else
                            <a href="{{route('cart')}}" class="dropdown-toggle" role="button" aria-haspopup="true"
                                aria-expanded="false" data-display="static">
                                @endif
