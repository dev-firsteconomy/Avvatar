									...
									<table border="0" cellpadding="0" cellspacing="0" width="100%" id="template_header" style='background-color: #000000; color: #ffffff; border-bottom: 0; font-weight: bold; line-height: 100%; vertical-align: middle; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; border-radius: 3px 3px 0 0;'>
										<tr>
											<td id="header_wrapper" style="padding: 36px 48px; display: block;">
												<h1 style='font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; font-size: 30px; font-weight: 300; line-height: 150%; margin: 0; text-align: left; text-shadow: 0 1px 0 #333333; color: #ffffff; background-color: inherit;'>Welcome to Our Community</h1>
											</td>
										</tr>
									</table>
									<!-- End Header -->
													...
													<tr>
														<td valign="top" style="padding: 48px 48px 32px;">
															<div id="body_content_inner" style='color: #636363; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; font-size: 14px; line-height: 150%; text-align: left;'>
																<p style="margin: 0 0 16px;">Hi Subscriber,</p>
																<p style="margin: 0 0 16px;">Thank you for joining our community!</p>
																<p style="margin: 0 0 16px;">Rejoice, as you will now be able to know about new product arrivals and receive exclusive news on exciting offers and discounts.</p>
																<p style="margin: 0 0 16px;">To make your shopping experience easier and faster at {{ env('APP_NAME') }}, we encourage you to create an account with us on www.{{ env('APP_NAME') }}.com</p>
																<p style="margin: 0 0 16px;">We look forward to sharing the free-spirited world of Global Desi with you soon!</p>
																<p style="margin: 0 0 16px;">Regards,<br>
																Team {{ env('APP_NAME') }}<br>
																http://{{ env('APP_NAME') }}.com</p>
															</table>
															</div>
														</td>
													</tr>
