...
<html lang="en-US">
	<head>
		...
		<title>Invoice for order {{$orderDetails->order_number}} on {{ env('APP_NAME') }}</title>
	</head>
									...
									<table border="0" cellpadding="0" cellspacing="0" width="100%" id="template_header" style='background-color: #000000; color: #ffffff; border-bottom: 0; font-weight: bold; line-height: 100%; vertical-align: middle; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; border-radius: 3px 3px 0 0;'>
										<tr>
											<td id="header_wrapper" style="padding: 36px 48px; display: block;">
												<h1 style='font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; font-size: 30px; font-weight: 300; line-height: 150%; margin: 0; text-align: left; text-shadow: 0 1px 0 #333333; color: #ffffff; background-color: inherit;'>Invoice for order {{$orderDetails->order_number}}</h1>
											</td>
										</tr>
									</table>
									<!-- End Header -->
													...
													<tr>
														<td valign="top" style="padding: 48px 48px 32px;">
															<div id="body_content_inner" style='color: #636363; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; font-size: 14px; line-height: 150%; text-align: left;'>
																...
																<p style="margin: 0 0 16px;">Here are the details of your order placed on {{date('d-m-Y', strtotime($orderDetails->created_at))}}:</p>
																<p style="margin: 0 0 16px;">Pay with Razorpay.</p>
																	...
																	<table cellspacing="0" cellpadding="6" border="1" style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;width:100%;font-family:'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif">
																		...
																		<tfoot>
																			<tr>
																				...
																				<td style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;padding:12px;text-align:left;border-top-width:4px"><span><span>₹</span>{{$orderDetails->taxable_amount}}</span></td>
																			</tr>
																			<tr>
																			...
																			<?php
																			       $taxAmt = $orderDetails->total_amount - ( $orderDetails->total_amount * (100/(100 + $taxPercent))); 
																			?>
																			<tr>
																				...
																				<td style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;padding:12px;text-align:left">{{number_format($orderDetails->total_amount - $taxAmt,2)}}</td>
																			</tr>
																			@if($orderDetails->state_id == 22)
																				<tr>
																					...
																					<td style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;padding:12px;text-align:left"><span><span>₹</span>{{number_format($taxAmt/2,2)}}</span></td>
																				</tr>
																				<tr>
																			...
																			@else
																				<tr>
																					...
																					<td style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;padding:12px;text-align:left"><span><span>₹</span>{{number_format($taxAmt,2)}}</span></td>
																				</tr>
																			@endif
																			<tr>
