													...
													<tr>
														<td valign="top" style="padding: 48px 48px 32px;">
															<div id="body_content_inner" style='color: #636363; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; font-size: 14px; line-height: 150%; text-align: left;'>
																...
																<p style="margin: 0 0 16px;">This notice confirms that your password was changed on {{ env('APP_NAME') }}.</p>
																<p style="margin: 0 0 16px;">If you did not change your password, please contact the Site Administrator at admin@{{ env('APP_NAME') }}.com</p>
