...
<html lang="en-US">
	<head>
		...
		<title>Your {{ env('APP_NAME') }} order #2956 has been refunded</title>
	</head>
									...
									<table border="0" cellpadding="0" cellspacing="0" width="100%" id="template_header" style='background-color: #000000; color: #ffffff; border-bottom: 0; font-weight: bold; line-height: 100%; vertical-align: middle; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; border-radius: 3px 3px 0 0;'>
										<tr>
											<td id="header_wrapper" style="padding: 36px 48px; display: block;">
												<h1 style='font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; font-size: 30px; font-weight: 300; line-height: 150%; margin: 0; text-align: left; text-shadow: 0 1px 0 #333333; color: #ffffff; background-color: inherit;'>Order Refunded: 2956</h1>
											</td>
										</tr>
									</table>
									<!-- End Header -->
													...
													<tr>
														<td valign="top" style="padding: 48px 48px 32px;">
															<div id="body_content_inner" style='color: #636363; font-family: "Helvetica Neue", Helvetica, Roboto, Arial, sans-serif; font-size: 14px; line-height: 150%; text-align: left;'>
																...
																<p style="margin: 0 0 16px;">Your order on Essay has been refunded. There are more details below for your reference:</p>
																...
																<div style="margin-bottom:40px">
																	<table cellspacing="0" cellpadding="6" border="1" style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;width:100%;font-family:'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif">
																		...
																		<tbody>
																			<tr>
																				<td style="color:#636363;border:1px solid #e5e5e5;padding:12px;text-align:left;vertical-align:middle;font-family:'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif;word-wrap:break-word">Mens Polo
																					<ul style="font-size:small;margin:1em 0 0;padding:0;list-style:none">
																						<li style="margin:0.5em 0 0;padding:0">
																							<strong style="float:left;margin-right:.25em;clear:both">Color:</strong> <p style="margin:0">Black</p>
																						</li>
																						<li style="margin:0.5em 0 0;padding:0">
																						<strong style="float:left;margin-right:.25em;clear:both">Size:</strong> <p style="margin:0">M</p>
																						</li>
																					</ul>
																				</td>
																		...
																		<tfoot>
																			<tr>
																				...
																				<td style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;padding:12px;text-align:left;border-top-width:4px"><span><span>₹</span>100.00</span></td>
																			</tr>
																			<tr>
																			...
																			<tr>
																				<th scope="row" colspan="2" style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;padding:12px;text-align:left">Refund:</th>
																				<td style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;padding:12px;text-align:left"><span><span>₹</span>-100.00</span></td>
																			</tr>
																			<tr>
																				...
																				<td style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;padding:12px;text-align:left">
																					<del aria-hidden="true">₹100.00</del> <ins><span><span>₹</span>0.00</span></ins>
																				</td>
																			</tr>
																			<tr>
																				...
																				<td style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;padding:12px;text-align:left">Testing Order</td>
																			</tr>
																		</tfoot>
																	</table>
																</div>
																...
																<table cellspacing="0" cellpadding="0" border="0" style="width:100%;vertical-align:top;margin-bottom:40px;padding:0">
																	<tbody>
																		<tr>
																			...
																			test<br>bhola gupta<br>Atul Tower<br>Kandivali West<br>Mumbai 400067<br>Maharashtra									<br><a href="tel:8898440963" style="color:#96588a;font-weight:normal;text-decoration:underline" target="_blank">8898440963</a>													<br><a href="mailto:bhola.8898@gmail.com" target="_blank">bhola.8898@gmail.com</a>							</address>
																			</td>
																			<td valign="top" width="50%" style="text-align:left;font-family:'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif;padding:0">
																				...
																				<address style="padding:12px;color:#636363;border:1px solid #e5e5e5">
																					test<br>bhola gupta<br>Atul Tower<br>Kandivali West<br>Mumbai 400067<br>Maharashtra									</address>
																			</td>
																	</tr>
																</tbody>
															</table>
															<p style="margin:0 0 16px">We hope to see you again soon.</p>
															</div>
														</td>
													</tr>
												</table>
