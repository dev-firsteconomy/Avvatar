		...
		<tr>
			<td align="center" valign="top">
				<div id="template_header_image">
					{{-- <p style="margin-top: 0;"><img src="{{URL::asset('assets/images/new/logo.png')}}" alt="Avaatar" style="border: none; display: inline-block; font-size: 14px; font-weight: bold; height: 50px; outline: none; text-decoration: none; text-transform: capitalize; vertical-align: middle; max-width: 100%; margin-left: 0; margin-right: 0;"></p>
				</div> --}}
																...
																<tbody>
																	...
																	<tr>
																		<td style="color:#636363;border:1px solid #e5e5e5;padding:12px;text-align:left;vertical-align:middle;font-family:'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif;word-wrap:break-word">{{$list->product->name}}
																			...
																			<ul style="font-size:small;margin:1em 0 0;padding:0;list-style:none">
																				<li style="margin:0.5em 0 0;padding:0">
																					<strong style="float:left;margin-right:.25em;clear:both">Color:</strong>
																					<p style="margin:0">{{$list->color->name}}</p>
																				</li>
																				<li style="margin:0.5em 0 0;padding:0">
																					<strong style="float:left;margin-right:.25em;clear:both">Size:</strong>
																					<p style="margin:0">{{$list->size->name}}</p>
																				</li>
																			</ul>
																			@endif
																		</td>
																		...
																		<?php
																						...
																						?>
																		<td style="color:#636363;border:1px solid #e5e5e5;padding:12px;text-align:left;vertical-align:middle;font-family:'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif">
																			<span><span>₹</span>{{number_format($list->taxable_amount,2)}}</span>
																		</td>
